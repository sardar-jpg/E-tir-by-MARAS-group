...
const LABELS: Record<Language, {
  ...
  en: {
    ...
    closedBanner: "This job is closed. You can read the conversation, but new messages can't be sent.",
  ...
  tr: {
    ...
    closedBanner: "Bu sefer kapatıldı. Konuşmayı okuyabilirsiniz ancak yeni mesaj gönderilemez.",
  ...
  ar: {
    ...
    closedBanner: "هذه المهمة مغلقة. يمكنك قراءة المحادثة، لكن لا يمكن إرسال رسائل جديدة.",
