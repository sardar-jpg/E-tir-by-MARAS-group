...
import { 
  ...
  Download, Printer, Compass, Navigation, Anchor, Plane
} from 'lucide-react';
...
export default function PublicTracking({ lang: initialLang, tokenFromUrl, onViewPrivacy, onViewTerms }: PublicTrackingProps) {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans tracking-tight pb-20 selection:bg-orange-500 selection:text-white" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <section className="bg-slate-900/90 border-b border-slate-800/80 sticky top-0 z-40 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3">
          ...
          {/* Quick Stats Ticker */}
          <div className="hidden lg:flex items-center gap-3 font-mono text-[10px] text-slate-450">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800/80 rounded-2xl p-6 relative overflow-hidden shadow-xl">
          <div className="absolute top-0 right-0 w-64 h-64 bg-orange-600/5 rounded-full blur-3xl pointer-events-none" />
          
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-800/60 pb-5">
            <div>
        ...
        <div className="bg-slate-900 border border-slate-805 rounded-2xl p-5 relative overflow-hidden shadow-lg">
          ...
          <div className="relative bg-slate-950 rounded-xl overflow-hidden mt-4 border border-slate-850/80">
            ...
            <div className="relative md:absolute md:bottom-3 md:left-4 md:right-4 mx-3 mb-3 md:mx-0 md:mb-0 mt-4 md:mt-0 bg-slate-900/90 border border-slate-800 p-3 rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-3 font-mono text-[10px]">
              <div className="flex items-center gap-1.5">
                <MapPin className="w-3.5 h-3.5 text-orange-400 shrink-0" />
                <span className="text-slate-400 uppercase">Live Routing Coordinates:</span>
              ...
              <div className="flex items-center gap-3">
                <span className="text-slate-405 flex items-center gap-1">
                  ...
                  <strong className="text-emerald-400 uppercase">ACTIVE SHARED</strong>
                </span>
                <span className="text-slate-500">|</span>
                <span>Est Distance Left: ~{Math.max(10, 100 - progressPercent)}%</span>
              </div>
            </div>
